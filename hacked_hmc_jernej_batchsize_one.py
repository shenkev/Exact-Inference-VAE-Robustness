...
l2_losses, recon_losses, l_latent_losses, x_samples, mean_imgs, vae_recon, vae_l2_loss, vae_recon_loss, vae_latent_loss \
    = sess.run([l2_losses, recon_losses, l_latent_losses, x_samples, mean_imgs, vae_recon, vae_l2_loss, vae_recon_loss, vae_latent_loss], feed_dict={model_eval._training:False})
